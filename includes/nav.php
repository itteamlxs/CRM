...
<nav class="bg-blue-800 shadow-lg">
        ...
        <div class="flex justify-between h-16">
            <div class="flex space-x-8">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <a href="<?php echo url('pages/clientes/index.php'); ?>" 
                    ...
                    <a href="<?php echo url('pages/productos/index.php'); ?>" 
                    ...
                    <a href="<?php echo url('pages/cotizaciones/index.php'); ?>" 
                    ...
                    <a href="<?php echo url('pages/ventas/index.php'); ?>" 
                    ...
                    <a href="<?php echo url('pages/reportes.php'); ?>" 
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if ($userRole === 'admin'): ?>
                    ...
                    <a href="<?php echo url('pages/usuarios/index.php'); ?>" 
    ...
    <div class="md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="<?php echo url('pages/dashboard.php'); ?>" class="text-white hover:bg-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                <?php echo htmlspecialchars($lang['nav_dashboard'] ?? 'Dashboard', ENT_QUOTES, 'UTF-8'); ?>
            </a>
            <a href="<?php echo url('pages/clientes/index.php'); ?>" class="text-white hover:bg-blue-700 block px-3 py-2 rounded-md text-base font-medium">
                <?php echo htmlspecialchars($lang['nav_clients'] ?? 'Clientes', ENT_QUOTES, 'UTF-8'); ?>
            </a>
